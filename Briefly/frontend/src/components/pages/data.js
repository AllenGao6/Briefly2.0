...
export const captions = [
  [
    <Typography variant="h3">160 Hand-Picked Questions</Typography>,
    <Typography variant="h3">100+ Hour Videos of Explanations</Typography>,
    <Typography variant="h3">Data Structure Crash Course</Typography>,
  ],
  [
    <Typography variant="h3">Solution in 9 Languages</Typography>,
    <Typography variant="h3">Code-Execution Environment</Typography>,
    <Typography variant="h3">Space-Time Complexity Analysis</Typography>,
  ],
  [
    <Typography variant="h3">4 Curated Assessments</Typography>,
    <Typography variant="h3">Certificate Of Completion</Typography>,
    <Typography variant="h3">Mock Coding Interviews</Typography>,
  ],
];
